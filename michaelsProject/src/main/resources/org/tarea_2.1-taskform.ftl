<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("datMod_2_out");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid datMod_2_out");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: michaelProcess.tarea_2.1
	</div>
	<div id="content">
		<fieldset>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">datMod_02_in</label>
                            		<div class="div_checkbox">
                              		${datMod_02_in}
                            		</div>
          ...
          <fieldset>
            ...
            <form action="complete" method="POST" enctype="multipart/form-data" onsubmit="return taskFormValidator()">
                            		<label for="name">datMod_2_out</label>
                            		<div class="div_texbox">
                              		<input name="datMod_2_out" type="text" class="textbox" id="datMod_2_out" value="" />
                            		</div>
